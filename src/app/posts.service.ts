...
export class PostsService {
  ...
  comment(id, data) {
    if (data === null || data === '') {
      ...
      this.posts[id].comments.push({name:this.storage.getName() , image:'https://www.kindpng.com/picc/m/78-786207_user-avatar-png-user-avatar-icon-png-transparent.png', comment:data });
    }
  }
 ...
 friends = [
  ...
  posts = [
    ...
    },
    {
      ...
      likePressed : false,
      showComments: false,
      comments: [{name:'mordik' , comment: "c'est très jolie" , image:'https://thumbs.dreamstime.com/z/happy-smiling-geek-hipster-beard-man-cool-avatar-geek-man-avatar-104871313.jpg'}],
      id: 1,
    },
    {
